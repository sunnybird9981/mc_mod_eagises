...
public class EffectListMenuButton4Procedure {
	public static void execute(Entity entity) {
		...
		if (_mobEffectListToClear.contains(_mobEffectListAll.get(3 + _effectListMenuIndex))) {
			_mobEffectListToClear.remove(_mobEffectListAll.get(3 + _effectListMenuIndex));
		} else {
			_mobEffectListToClear.add(_mobEffectListAll.get(3 + _effectListMenuIndex));
		}
