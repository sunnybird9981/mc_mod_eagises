...
import net.mcreator.aegisesmod.procedures.ClearPotionEffectsOnKeyPressedProcedure;
...
public class ClearPotionEffectsMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AegisesMod.addNetworkMessage(ClearPotionEffectsMessage.class, ClearPotionEffectsMessage::buffer, ClearPotionEffectsMessage::new, ClearPotionEffectsMessage::handler);
	}
}
