...
import net.mcreator.mymod.potion.ForesightCoolDownEffectMobEffect;
import net.mcreator.mymod.potion.AegisPneumaEffectMobEffect;
import net.mcreator.mymod.potion.AegisFreezeEffectMobEffect;
import net.mcreator.mymod.potion.AegisCooldownEffectMobEffect;
import net.mcreator.mymod.MymodMod;

public class MymodModMobEffects {
	public static final DeferredRegister<MobEffect> REGISTRY = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, MymodMod.MODID);
