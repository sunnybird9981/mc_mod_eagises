...
import net.mcreator.mymod.procedures.TogglePurifyingFlameStatProcedure;
...
public class TogglePurifyingFlamesStatMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MymodMod.addNetworkMessage(TogglePurifyingFlamesStatMessage.class, TogglePurifyingFlamesStatMessage::buffer, TogglePurifyingFlamesStatMessage::new, TogglePurifyingFlamesStatMessage::handler);
	}
}
