...
import net.mcreator.mymod.procedures.EffectListMenuUpArrowProcedure;
import net.mcreator.mymod.procedures.EffectListMenuDownArrowProcedure;
import net.mcreator.mymod.procedures.EffectListMenuButton5Procedure;
import net.mcreator.mymod.procedures.EffectListMenuButton4Procedure;
import net.mcreator.mymod.procedures.EffectListMenuButton3Procedure;
import net.mcreator.mymod.procedures.EffectListMenuButton2Procedure;
import net.mcreator.mymod.procedures.EffectListMenuButton1Procedure;
...
public class EffectlistMenuButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MymodMod.addNetworkMessage(EffectlistMenuButtonMessage.class, EffectlistMenuButtonMessage::buffer, EffectlistMenuButtonMessage::new, EffectlistMenuButtonMessage::handler);
	}
}
