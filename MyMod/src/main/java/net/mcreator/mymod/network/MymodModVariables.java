...
public class MymodModVariables {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		MymodMod.addNetworkMessage(PlayerVariablesSyncMessage.class, PlayerVariablesSyncMessage::buffer, PlayerVariablesSyncMessage::new, PlayerVariablesSyncMessage::handler);
	}
	...
	private static class PlayerVariablesProvider implements ICapabilitySerializable<Tag> {
		...
		public static void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
			if (event.getObject() instanceof Player && !(event.getObject() instanceof FakePlayer))
				event.addCapability(new ResourceLocation("mymod", "player_variables"), new PlayerVariablesProvider());
		}
	...
	public static class PlayerVariables {
		...
		public List<MobEffect> getMobEffectListToClear(Entity entity) {
			List<MobEffect> _mobEffectListToClear = (entity.getCapability(MymodModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new PlayerVariables())).mobEffectListToClear;
			return _mobEffectListToClear;
		}
		...
		public void syncPlayerVariables(Entity entity) {
			if (entity instanceof ServerPlayer serverPlayer) {
				MymodMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> serverPlayer), new PlayerVariablesSyncMessage(this));
