...
import net.mcreator.mymod.procedures.ShowEffectListMenuProcedure;
...
public class ShowEffectListMenuKeyMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MymodMod.addNetworkMessage(ShowEffectListMenuKeyMessage.class, ShowEffectListMenuKeyMessage::buffer, ShowEffectListMenuKeyMessage::new, ShowEffectListMenuKeyMessage::handler);
	}
}
