...
public class EffectListMenuButton1Procedure {
	public static void execute(Entity entity) {
		...
		if (_mobEffectListToClear.contains(_mobEffectListAll.get(0 + _effectListMenuIndex))) {
			_mobEffectListToClear.remove(_mobEffectListAll.get(0 + _effectListMenuIndex));
		} else {
			_mobEffectListToClear.add(_mobEffectListAll.get(0 + _effectListMenuIndex));
		}
