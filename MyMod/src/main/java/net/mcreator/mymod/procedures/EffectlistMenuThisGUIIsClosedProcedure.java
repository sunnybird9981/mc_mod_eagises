...
public class EffectlistMenuThisGUIIsClosedProcedure {
	public static void execute(Entity entity) {
		...
		_mobEffectListToClear = (entity.getCapability(MymodModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new MymodModVariables.PlayerVariables())).mobEffectListToClear;
		if (entity == null)
			return;
